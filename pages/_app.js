...
function SocialMedia(){
  return(
    <div className='fixed flex flex-row items-center justify-center space-x-2 opacity-80 top-2 left-auto right-auto text-gray-100 w-full '>
        <div>
          <Link 
